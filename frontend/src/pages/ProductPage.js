...
import { useIncreaseCartProductMutation } from "../services/appApi";
                ...
                <Col lg={6} className="pt-4">
                    ...
                    {user && !user.isAdmin && (
                        <ButtonGroup style={{ width: "90%" }}>
                            <Form.Select onChange={(e) => setCount(e.target.value)}  size="lg" style={{ width: "40%", borderRadius: "0" }}>
                            ...
                            <Button size="lg" onClick={() => addToCart({ userId: user._id, productId: id, price: product.price, image: product.pictures[0].url , count: count })}>
                                Add to cart
                            </Button>
                        </ButtonGroup>
                    )}
